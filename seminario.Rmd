...
totalCC_Asturias <- tabla_resultadosCCAsturias[3, 3:7]  # Fila 3, columnas de enero a mayo
# Convertir los datos a formato largo (meses en una columna)
datos_long <- data.frame(mes = colnames(tabla_resultadosCCAsturias)[3:7],  # Nombres de las columnas de enero a mayo
