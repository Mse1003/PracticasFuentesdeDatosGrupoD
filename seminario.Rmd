...
primer_fila_cancer_post_asturias <- min(filas_cancer_colon[filas_cancer_colon > fila_asturias])
...
filas_seleccionadas <- c(fila_asturias, 
                         primer_fila_cancer_post_asturias, 
                         primer_fila_cancer_post_asturias + 1, 
                         primer_fila_cancer_post_asturias + 2, 
                         primer_fila_cancer_post_asturias + 3)
