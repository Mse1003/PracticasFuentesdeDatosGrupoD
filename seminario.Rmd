...
#tratamiento de los datos del agua
...
```
#conclusion
#Los resultados del ejercicio 3 indican una débil correlación entre algunos parámetros de calidad del agua como los nitrato y la incidencia de cáncer de colon. Sin embargo estas relaciones no son concluyentes lo que sugiere que otros factores posiblemente sociales o ambientales podrían desempeñar un papel más relevante en la incidencia de la enfermedad en Asturias.
-------------------------------------------------------------------------------------------
